...
- 試験: **`antenna_main/開発ツール/試験/`**（git で残る。2026-09-11 から。作業場だけに置くとコンテナが消えると一緒に失う）。
  ...
  変異試験は `変異/版156.py`（版156 の決まり）・`変異/版157.py`（版157）・`変異/版158.py`（版158）・`変異/版159.py`（版159）・`変異/版160.py`（版160）・`変異/版161.py`（版161）・`変異/版162.py`（版162）・`変異/版163.py`（版163）・`変異/版164.py`（版164）・`変異/版165.py`（版165）・`変異/版166.py`（版166）。
